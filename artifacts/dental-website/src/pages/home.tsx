...
const BeforeAfterImage = ({
  ...
  return (
    <div
      ref={containerRef}
      className="relative aspect-square rounded-3xl overflow-hidden cursor-ew-resize shadow-lg select-none"
      onMouseEnter={() => setActive(true)}
      onMouseLeave={handleMouseLeave}
      onMouseMove={handleMouseMove}
    >
      {/* Base: BEFORE image always fully visible */}
      <img
        src={before}
        alt={`Before ${label}`}
        className="absolute inset-0 w-full h-full object-cover"
      />
      {/* AFTER image — clipped to the left of the divider position */}
      <img
        src={after}
        alt={`After ${label}`}
      ...
      <div className="absolute top-4 left-4 z-20 bg-black/50 backdrop-blur-sm text-white text-xs font-bold px-3 py-1.5 rounded-full pointer-events-none">
        BEFORE
      </div>
      {/* AFTER label — top-right */}
      <div className="absolute top-4 right-4 z-20 bg-primary/90 backdrop-blur-sm text-white text-xs font-bold px-3 py-1.5 rounded-full pointer-events-none">
        AFTER
      </div>

      {/* Divider line + handle — follows mouse X position */}
      <div
        className="absolute inset-y-0 z-20 w-0.5 bg-white shadow-[0_0_8px_rgba(0,0,0,0.6)] pointer-events-none flex items-center justify-center"
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                variants={fadeInUp}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary font-medium text-sm mb-6 border border-primary/20 shadow-sm"
              >
              ...
              <motion.h1
                variants={fadeInUp}
                className="text-5xl md:text-7xl font-serif font-bold text-foreground leading-tight mb-6 tracking-tight"
              >
                Anxiety-free dentistry. <br />
                <span className="text-primary italic font-light">
                  Book today, smile today.
                </span>
              </motion.h1>
              <motion.p
                variants={fadeInUp}
              ...
              >
                The antidote to the dentist you've been avoiding. Experience
                pain-free technology in a space that feels like a wellness
                studio, right in the heart of Chicago.
              </motion.p>
              <motion.div
                variants={fadeInUp}
              ...
              >
                <Button
                  size="lg"
                  className="rounded-full text-base h-14 px-8 shadow-lg shadow-primary/25 hover:shadow-xl hover:-translate-y-1 transition-all"
                  asChild
                >
                  <Link href="/book">
                    Book Appointment
              ...
              <motion.div
                variants={fadeInUp}
                className="mt-10 flex items-center gap-4 text-sm text-muted-foreground bg-background/50 backdrop-blur-sm p-4 rounded-2xl inline-flex shadow-sm border border-border/50"
              >
                ...
                <div className="font-medium">
                  <strong className="text-foreground">4.9/5</strong> rating from{" "}
                  <strong className="text-foreground">500+</strong> patients
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <div
                className="absolute -bottom-8 -left-8 bg-background p-6 rounded-3xl shadow-xl max-w-xs border border-border/50 animate-bounce"
      ...
      <section className="py-16 bg-destructive/10 border-y border-destructive/20 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl px-4 text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-foreground mb-4">
            In Dental Pain? We Can Help Today.
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Don't wait if you're experiencing severe toothache, a broken tooth,
            or a lost filling. We reserve specific times every day for emergency
            patients.
          </p>
          <Button
            size="lg"
            className="rounded-full h-16 px-10 text-lg bg-destructive hover:bg-destructive/90 text-destructive-foreground shadow-lg shadow-destructive/30 animate-pulse transition-all hover:scale-105"
            asChild
          >
            <a href="tel:+13125550190">
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute top-1/2 -right-8 -translate-y-1/2 bg-white p-6 rounded-3xl shadow-xl hidden lg:block max-w-[240px]">
                <p className="font-serif italic text-lg leading-relaxed text-foreground">
                  "Going to the dentist shouldn't cause anxiety. We're here to
                  change that."
                </p>
            ...
            >
              ...
              >
                A Chicago native, Dr. Mitchell built this practice with a
                singular vision: to create a dental environment that feels safe,
                transparent, and remarkably gentle. She specializes in treating
              ...
              <motion.div variants={fadeInUp}>
                <img
                  ...
                  alt="Signature"
                  className="h-12 opacity-30 mix-blend-multiply dark:invert"
                />
              </motion.div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-foreground">
              Comprehensive, Gentle Care
            </h2>
            <p className="text-lg text-muted-foreground">
              From routine cleanings to complete smile makeovers, we provide all
              the care you need under one roof using the latest technology.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Preventative care to keep your smile healthy and bright.",
                icon: Sparkles,
              },
              {
                title: "Teeth Whitening",
                desc: "Professional, long-lasting brightening for a radiant smile.",
                icon: Smile,
              },
              {
              ...
              },
              {
                ...
                desc: "Gentle, fun, and educational care for our youngest patients.",
                icon: Baby,
              },
              {
                title: "Emergency Care",
                desc: "Same-day appointments available for urgent dental needs.",
                icon: Phone,
              },
              {
                title: "Root Canal",
              ...
              },
              {
                ...
                desc: "Custom-crafted restorations to protect and beautify your teeth.",
                icon: Syringe,
              },
            ].map((service, i) => (
              <motion.div
      ...
      <section className="py-24 bg-background border-t border-border/30">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Real results from our Chicago clinic. Hover or drag to see the
              difference.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <BeforeAfterImage
                before="/before-whitening.png"
                after="/after-whitening.png"
                label="Teeth Whitening"
              />
              <h3 className="text-xl font-serif font-bold mt-6 mb-2 text-center">
            ...
            >
              <BeforeAfterImage
                before="/before-invisalign.png"
                after="/after-invisalign.png"
                label="Invisalign"
              />
              <h3 className="text-xl font-serif font-bold mt-6 mb-2 text-center">
                Invisalign
            ...
            >
              <BeforeAfterImage
                before="/before-implants.png"
                after="/after-implants.png"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-background/70 mb-8 leading-relaxed">
                We've thoughtfully designed our clinic to remove the clinical
                feel of traditional dentistry. Enjoy natural light, calming
                music, and state-of-the-art technology that makes your treatment
              ...
              <div className="bg-background/10 p-6 rounded-2xl border border-background/20 backdrop-blur-sm">
                ...
                <ul className="space-y-3 text-background/80">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> Strict CDC
                    compliance & sterilization protocols
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> Single-use
                    instruments where applicable
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" />{" "}
                    Hospital-grade disinfectants between every patient
                  </li>
                  <li className="flex items-center gap-2">
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto max-w-3xl px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Everything you need to know about visiting Mitchell Dental Care.
            </p>
          </div>
          ...
          <Accordion type="single" collapsible className="w-full">
            {[
              {
                q: "Does it hurt?",
                a: "No. We specialize in pain-free dentistry. We use strong topical anesthetics before any injection, and we don't start any procedure until you are completely numb and comfortable.",
              },
              {
                q: "Do you accept my insurance?",
                a: "Yes, we accept most major PPO plans including Delta Dental, Cigna, MetLife, Aetna, BlueCross BlueShield, and United Healthcare. We'll handle all the paperwork and verify your benefits before your appointment.",
              },
              {
                q: "What if I have severe dental anxiety?",
                a: "You are our ideal patient. Let us know when you book. We offer a calm environment, noise-canceling headphones, comfort items, and take everything at your pace. We promise to never judge the state of your teeth.",
              },
              {
                q: "How much does it cost?",
                a: "We believe in 100% transparency. Before any treatment begins, we will provide a detailed breakdown of costs and what your insurance will cover. No surprise bills, ever.",
              },
              {
                q: "Do you offer payment plans?",
                a: "Yes! We offer 0% financing options and accept CareCredit. We believe everyone deserves excellent dental care, and we'll work with you to find a payment plan that fits your budget.",
              },
              {
                q: "What's your emergency process?",
                a: "If you have a dental emergency, call us immediately at (312) 555-0190. We reserve specific slots every day for emergencies and will do everything possible to see you the same day.",
              },
              {
                q: "How long does a cleaning take?",
                a: "A standard checkup and cleaning usually takes about 45 to 60 minutes. If it's your first time with us, expect about 60-75 minutes so we can take comprehensive X-rays and Dr. Mitchell can do a full exam.",
              },
              {
                q: "Do you see children?",
                a: "Yes, we love seeing kids! We offer pediatric dentistry for children ages 3 and up, making sure their first experiences with the dentist are fun and positive.",
              },
            ].map((faq, i) => (
              <AccordionItem
                key={i}
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-10">
                We're currently accepting new patients. Fill out the form, or
                give us a call to schedule your visit.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      1200 N Michigan Ave, Suite 400
                      <br />
                      Downtown Chicago, IL 60611
                    </p>
                  </div>
                </div>
              ...
              <div
                id="insurance"
                className="p-8 bg-background rounded-3xl border border-border shadow-sm"
              >
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  We handle the paperwork for you. We accept most major PPO
                ...
                <p className="text-sm text-muted-foreground p-4 bg-primary/5 rounded-xl border border-primary/10">
                  ...
                  We offer 0% financing, accept CareCredit, and have flexible
                  payment plans available for all patients.
                </p>
              </div>
            </motion.div>
              ...
              <Card className="border-border shadow-2xl rounded-[2rem] overflow-hidden sticky top-24">
                <div className="bg-primary p-6 text-primary-foreground">
                  ...
                  <p className="text-primary-foreground/80 text-sm mt-2">
                    Fast, easy, and secure. We'll call you to confirm.
                  </p>
                </div>
                <CardContent className="p-8 md:p-10 bg-background">
                  <form onSubmit={handleBookingSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="message"
                        placeholder="Any specific concerns or dental anxiety? Let us know."
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full rounded-xl h-14 text-lg shadow-lg hover:shadow-xl transition-all"
                    >
                      Request Appointment
                    </Button>
                    <p className="text-xs text-center text-muted-foreground mt-4 flex items-center justify-center gap-1">
                      <ShieldCheck className="w-3 h-3" /> Secure and
                      confidential
                    </p>
                  </form>
                </CardContent>
      ...
      <footer className="bg-foreground text-background py-16 pb-32 md:pb-16">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-background/70 max-w-sm leading-relaxed">
                Providing exceptional, compassionate dental care for the
                Downtown Chicago community. Your comfort is our priority, and
                your smile is our passion.
              </p>
            </div>
            <div>
              <h4 className="font-serif font-bold text-xl mb-6 text-primary">
                Quick Links
              </h4>
              <ul className="space-y-3 text-background/80">
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-background/80">
                <li>
                  ...
                  >
                    <Phone className="w-4 h-4" /> (312) 555-0190
                  </a>
                </li>
                <li>
                  <a
                    href="mailto:hello@mitchelldental.com"
                    className="hover:text-primary transition-colors"
                  >
          ...
          <div className="pt-8 border-t border-background/20 text-background/50 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
            <p>
              &copy; {new Date().getFullYear()} Mitchell Dental Care. All rights
              reserved.
            </p>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-background border-t border-border p-4 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] flex gap-3">
        ...
        <Button
          variant="outline"
          className="flex-1 rounded-full h-12 border-2 text-foreground"
          asChild
        >
          <a href="tel:+13125550190">
